...
require_once("DAO/ResponseCriteriaDAO.php");

/**
 * The ResponseCriteria class extends ResponseDAOCriteria and is used
 ...
 * @version 1.0
 */
class ResponseCriteria extends ResponseCriteriaDAO
{
