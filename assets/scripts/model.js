/**
 * backbone model definitions for Location Bot
 */
...
/**
 * Number Backbone Model
 */
model.NumberModel = Backbone.Model.extend({
	urlRoot: 'api/number',
	idAttribute: 'id',
	id: '',
	number: '',
...
/**
 * Number Backbone Collection
 */
model.NumberCollection = model.AbstractCollection.extend({
	url: 'api/numbers',
	model: model.NumberModel
});

/**
 * Response Backbone Model
 */
model.ResponseModel = Backbone.Model.extend({
...
/**
 * Response Backbone Collection
 */
model.ResponseCollection = model.AbstractCollection.extend({
	url: 'api/responses',
